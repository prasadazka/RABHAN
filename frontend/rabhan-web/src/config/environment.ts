...
const development: Config = {
  apiUrl: '/api',
  documentServiceUrl: import.meta.env.VITE_DOCUMENT_API_URL || 'http://localhost:3003/api/documents',
  authServiceUrl: import.meta.env.VITE_AUTH_API_URL || 'http://localhost:3001/api/auth',
  solarApiUrl: import.meta.env.VITE_SOLAR_API_URL || 'http://localhost:3005/api/solar-calculator',
  userApiUrl: import.meta.env.VITE_USER_API_URL || 'http://localhost:3002/api/users',
  contractorApiUrl: import.meta.env.VITE_CONTRACTOR_API_URL || 'http://localhost:3004/api/contractors',
