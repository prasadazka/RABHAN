...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // RABHAN Solar BNPL Platform Brand Colors
        primary: {
          50: '#f0fdfc',
          100: '#ccfbf7',
          200: '#9df5ef',
          300: '#5eeae3',
          400: '#3eb2b1', // Main brand color
          500: '#14b8a6',
          600: '#0d9488',
          700: '#0f766e',
          800: '#115e59',
      ...
      boxShadow: {
        ...
        'saudi': '0 4px 20px 0 rgba(0, 108, 53, 0.15)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'saudi-pattern': 'linear-gradient(135deg, #3eb2b1 0%, #006C35 100%)',
      },
    },
  },
  plugins: [
